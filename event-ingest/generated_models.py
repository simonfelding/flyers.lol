...
#   timestamp: 2025-05-09T15:07:03+00:00
...
class Geo(BaseModel):
    lat: float = Field(..., description='Latitude of the event.', example=34.0522)
    lon: float = Field(..., description='Longitude of the event.', example=-118.2437)
